...
CREATE TABLE questions (lec int, q int, lec_q_id text, question text, PRIMARY KEY (lec, q));
...
QUERY my_answers_for_lec: SELECT answers.* FROM answers WHERE answers.lec = ? AND answers.email = ?;
